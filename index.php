...
<!-- <div id="wrapper"> -->
        ...
        <div id="banner-content" class="row clearfix">
            ...
            <div class="col-38">
                ...
                <div class="section-heading">
                    <h1>DECOMPOSING CARBON, PIONEERING SUSTAINABILITY</h1>
                </div>
    ...
    <main id="content">
        ...
        <!--Introduction-->
        <section id="technology" class="introduction scrollto">
                ...
                <div class="col-2-3">
                    ...
                    <div class="col-2 icon-block icon-top wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <div class="icon-block-description">
                            <h4>CAPTURING ANTHROPOGENIC CO<sub>2</sub></h4>
                            <p>Unleashing Innovation: Capturing anthropogenic CO<sub>2</sub> , transforming it to value. A sustainable solution for a greener tomorrow.</p>
                        </div>
                    </div>
                    <!--End of Icon Block-->
                    ...
                    <div class="col-2 icon-block icon-top wow fadeInUp" data-wow-delay="0.3s">
                        ...
                        <!--Icon Block Description-->
                        <div class="icon-block-description">
                            <h4>FLUE GAS CAPTURING</h4>
                            <p>Turning emissions into opportunities. Our process not only captures flue gas, but transforms it into valuable resources, leading the way to a cleaner, more sustainable future.</p>
                        </div>
                    </div>
                    <!--End of Icon Block-->
                    ...
                    <div class="col-2 icon-block icon-top wow fadeInUp" data-wow-delay="0.5s">
                        <!--Icon-->
                        <div class="icon"  style="left: 1.5%;">
                            <i class="fa-solid fa-recycle fa-2x"></i>
                        </div>
                        <!--Icon Block Description-->
                        <div class="icon-block-description">
                            <h4>CO<sub>2</sub> INTO GRAPHITIC CARBON</h4>
                            <p>Transforming CO<sub>2</sub> into Graphitic Carbon, we pioneer a sustainable path towards a greener future, innovating for a world free of excess carbon emissions.</p>
                        </div>
                    </div>
                    <!--End of Icon Block-->
                    ...
                    <div class="col-2 icon-block icon-top wow fadeInUp" data-wow-delay="0.5s">
                        <!--Icon-->
                        <div class="icon">
                            <i class="fa-solid fa-truck-plane fa-2x"></i>
                        </div>
                        <!--Icon Block Description-->
                        <div class="icon-block-description">
        ...
        <section id="explaination" class="introduction scrollto">
            ...
            <div class="row clearfix">
                ...
                <div class="col-3">
                    <div class="section-heading">
                        ...
                        <h2 class="section-title">INNOVATING CARBON CAPTURING & DECOMPOSING</h2>
                        <p class="section-subtitle">Climatech pioneers sustainable technology, capturing carbon for a brighter future. Our innovation leads the way in creating eco-friendly solutions, setting us apart in the pursuit of environmental excellence.</p>
                    </div>
                ...
                <div class="col-2-3">
                    ...
                    <div class="col-2 icon-block icon-top wow fadeInUp" data-wow-delay="0.1s">
                        <!--Icon-->
                        <div class="icon">
                            <i class="fa-brands fa-creative-commons-zero fa-2x"></i>
                        </div>
                        <!--Icon Block Description-->
                        <div class="icon-block-description">
                    ...
                    <div class="col-2 icon-block icon-top wow fadeInUp" data-wow-delay="0.3s">
                        ...
                        <!--Icon Block Description-->
                        <div class="icon-block-description">
                            <h4>ENERGY EFFICIENT PROCESS</h4>
                            <p>Maximized efficiency: Our process emits only 45 kg to decompose 1 ton of CO<sub>2</sub>
                    ...
                    <div class="col-2 icon-block icon-top wow fadeInUp" data-wow-delay="0.5s">
                        ...
                        <div class="icon-block-description">
                            <h4>PURE OXYGEN</h4>
                            <p>Our process yields pure oxygen, bolstering environmental health and balancing ecosystems, and commitment towards sustainability.</p>
                        </div>
                    </div>
                    <!--End of Icon Block-->
        ...
        <div id="services" class="scrollto clearfix">
            ...
            <div class="row no-padding-bottom clearfix">
                ...
                <div class="col-3">
                    <div class="section-heading">
                        <h3>SERVICES</h3>
                        <h2 class="section-title">SUSTAINABLE SOLUTION FOR INDUSTRIES</h2>
                ...
                <div id="process" class="col-2" style="margin-left: 50px; margin-top: 70px; width: 61%;">
                    <img class="process" src="images/process.gif" alt="Process"/>
                </div>
 ...
 <!--                   <footer> <i class="fa-brands fa-linkedin fa-2x"></i>&nbsp; &nbsp; &nbsp; <i class="fa-solid fa-envelope fa-2x"></i>&nbsp; &nbsp; &nbsp; <i class="fa-brands fa-instagram fa-2x"></i> </footer>   -->
                    ...
                    <div class="row no-padding-bottom clearfix">
                        ...
                        <div class="col-3">
                            <div class="section-heading">
                                ...
                                <h2 class="section-title">OUR FOUNDERS WITH OUR TECHNOLOGY'S FIRST PROTOTYPE IN MNIT JAIPUR CAMPUS</h2>
                            </div>
                            <!-- Just replace the Video ID "UYJ5IjBRlW8" with the ID of your video on YouTube (Found within the URL) -->
                            <a href="#" data-videoid="UYJ5IjBRlW8" data-videosite="youtube" class="button video link-lightbox">
                                SEE OUR KEY MILESTONES &nbsp; <i class="fa fa-play" aria-hidden="true"></i>
                            </a>
                        </div>
                        <!--End Content Left Side-->
                        ...
                        <div id="process" class="col-2" style="margin-left: 50px; margin-top: 70px; width: 61%;">
                            <img class="process" src="images/us.jpg" alt="Process"/>
                        </div>
        ...
        <section id="ungoals" class="scrollto clearfix">
            <div class="row clearfix">
                ...
                <div class="col-3">
                    ...
                    <div class="section-heading">
                        <h3>UN SUSTAINABILITY GOALS</h3>
                        <h2 class="section-title">WE ARE ACHIEVING 9 OUT OF 17 UNITED NATION SUSTAINABILITY GOAL DEVELOPMENTS WITH OUR PROCESS</h2>
                    </div>
        ...
        <!--End of Clients-->
        <section id="recognization" class="scrollto clearfix">
            <div class="row clearfix">
                ...
                <div class="col-3">
                    ...
                    <div class="section-heading">
                        <h3>TRUST</h3>
                        <h2 class="section-title">OUR INCUBATORS</h2>
                    </div>
    ...
    <footer id="landing-footer" class="clearfix">
        <div class="row clearfix">
            ...
            <p id="copyright" class="col-2">Made with love by <a href="https://www.shapingrain.com">Climatech Environmental Pvt. Ltd.</a></p>
